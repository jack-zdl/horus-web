...
public class MemController {
    ...
    public Map<String,Object> getDayCpuMontiorByPo(String http, String cpuId){
    	...
    	try {
    		b=memService.getDayMemMontiorByPo("http://192.168.2.123:8000","14c11815035869cc37bccfb8c8d7154fa0de0163abbe4f0d83c7385edbb3eb41");
    ...
    public Map<String,Object> getWeekContentMontiorByPo(String http, String cpuId){
		 ...
		 JSONArray b=new JSONArray();
    	try {
    		b=memService.getWeekMemMontiorByPo("http://192.168.2.123:8000","14c11815035869cc37bccfb8c8d7154fa0de0163abbe4f0d83c7385edbb3eb41");
    ...
    public  Map<String,Object> getMonthContentMontiorByPo(String http, String cpuId){
		 ...
		 JSONArray b=new JSONArray();
    	try {
    		b=memService.getMonthMemMontiorByPo("http://192.168.2.123:8000","14c11815035869cc37bccfb8c8d7154fa0de0163abbe4f0d83c7385edbb3eb41");
