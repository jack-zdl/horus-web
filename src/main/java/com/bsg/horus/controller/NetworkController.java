...
public class NetworkController {
    ...
    public Map<String,Object> getDayNetworkMontiorByPo(){
    	...
    	try {
    		a=networkService.getDayNetworkMontiorByPo("http://192.168.2.123:8000","14c11815035869cc37bccfb8c8d7154fa0de0163abbe4f0d83c7385edbb3eb41");
    ...
    public Map<String,Object> getTestData(){
		 Map<String,Object> result=new HashMap<String,Object>();
    	try {
    		JSONObject a=networkService.getTestData("", "");
