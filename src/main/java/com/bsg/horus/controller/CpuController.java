...
public class CpuController {
    ...
    public Map<String,Object> getDayCpuMontiorByPo(String http, String cpuId){
    	...
    	try {
    		b=cpuService.getDayCpuMontiorByPo("http://192.168.2.123:8000","14c11815035869cc37bccfb8c8d7154fa0de0163abbe4f0d83c7385edbb3eb41");
    		result.put("cpu",b);
    ...
    public Map<String,Object> getTestDayCpuMontiorByPo(String http, String cpuId){
		 ...
		 JSONArray b=new JSONArray();
    	try {
    		b=cpuService.getTestDayCpuMontiorByPo("http://192.168.2.123:8000","14c11815035869cc37bccfb8c8d7154fa0de0163abbe4f0d83c7385edbb3eb41");
    ...
    public @ResponseBody Map<String,Object> testGetDayCpuMontiorByPoT(){
		Map<String,Object> result=new HashMap<String, Object>();
    	 JSONArray b=new JSONArray();
    	try {
    		b=cpuService.getTestHoursCpuMontiorByPo("http://192.168.2.123:8000","74290a3a437fcc0b9a2135cb5d35b6eae13b5fdb82418e49d2cdd173116e0a8d");
	 ...
	 *@Description 这里调用service，自动生成数据，
	   ...
	   @RequestMapping(value = "/testcpuWeek")
	    ...
	    public Map<String,Object> cpuWeekMonitor(){
	        Map<String,Object> result=new HashMap<String, Object>();
	        try {
	            List<Map> list = cpuService.cpuMonitor();
    ...
    public Map<String,Object> getWeekCpuMontiorByPo(String http, String cpuId){
		Map<String,Object> result=new HashMap<String, Object>();
    	 JSONArray b=new JSONArray();
    	try {
    		b=cpuService.getWeekCpuMontiorByPo("http://192.168.2.123:8000","14c11815035869cc37bccfb8c8d7154fa0de0163abbe4f0d83c7385edbb3eb41");
    ...
    public Map<String,Object> getMonthCpuMontiorByPo(String http, String cpuId){
   	 ...
   	 JSONArray b=new JSONArray();
   	try {
   		b=cpuService.getMonthCpuMontiorByPo("http://192.168.2.123:8000","14c11815035869cc37bccfb8c8d7154fa0de0163abbe4f0d83c7385edbb3eb41");
